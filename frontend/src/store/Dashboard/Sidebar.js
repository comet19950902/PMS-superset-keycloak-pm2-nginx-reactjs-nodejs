    ...
    <div className="dashboard maindashboard">
      <aside>
        <ul className="sidebar" style={{ marginLeft: '4%' }}>
          <li>
            <Link to="/PMS/dashboard" className="active" style={{ marginLeft: '3%', paddingLeft: '8%' }}>
              <svg
          ...
          <li>
            <Link to="/PMS/Assets/:4a47bdd9-a3c5-4ef9-b584-85042ca5aa8c" className="active" style={{ marginLeft: '3%', marginTop: '-5%', paddingLeft: '8%' }}>
              <svg
                id="Wallet"
                xmlns="http://www.w3.org/2000/svg"
                width="22.654"
        ...
        <li style={{marginTop:"-12%"}}>
          ...
          <li>
            <Link to="/PMS/AddWallet" className="active" style={{ marginLeft: '3%', marginTop: '-3%', paddingLeft: '8%' }}>
              <svg
                id="Wallet"
                xmlns="http://www.w3.org/2000/svg"
                width="22.654"
          ...
          <li>
            <Link to="/PMS/Investments" className="active" style={{ marginLeft: '3%', marginTop: '-1%', paddingLeft: '8%' }}>
              <svg
                id="Wallet"
                xmlns="http://www.w3.org/2000/svg"
                width="22.654"
          ...
          <li>
            <Link to="/PMS/Exchange" className="active" style={{ marginLeft: '3%', marginTop: '-1%', paddingLeft: '8%' }}>
              <svg
                id="Wallet"
                xmlns="http://www.w3.org/2000/svg"
                width="22.654"
          ...
          <li>
            <Link to="/PMS/AllAssets" style={{ marginLeft: '3%', marginTop: '-4%', paddingLeft: '8%' }} className="active">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22.654"
                height="22.654"
          ...
          <li>
            <Link to="/PMS/Transactions/:4a47bdd9-a3c5-4ef9-b584-85042ca5aa8c" style={{ marginLeft: '3%', marginTop: '-7%', paddingLeft: '8%' }} className="active">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22.654"
                height="22.654"
