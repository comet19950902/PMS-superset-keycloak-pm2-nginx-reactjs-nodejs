...
import Charts from '../FinalDashboard/chart/chart'
...
import ViewExchangeForAsset from '../../Accountant/ViewExchangeForAsset'
import ViewInvestmentForAssets from '../../Accountant/ViewInvestmentForAssets'
...
const AssetsAccountant = () => {
  ...
  const walletIdAddress = location.pathname.slice(24)
    ...
    <div>
      <div className="mainmyassets">
        <Row>
          ...
          <Col lg={newWidth} style={{ height: '90%', overflowY: 'scroll' }}>
            <Header />
            {showDashboard === true
            ...
            <div className="maindashinfo">
              ...
              >
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '28%' }}>
                    ...
                    <Link to={'/PMS/Account_dashboard'} style={{ marginLeft: '800%', marginTop: '7%' }} >
              ...
              {/* {alert ?
                   ...
                   : <></> } */}
              <div className="assets-chart-box" style={{ height: '16vh' }}>
                <Row>
                  <Col lg={3}>
                    <div
                      ...
                      {state === false
                        ? (
                            bal
                              ? (
                              <h4
                                style={{ fontSize: '15px', marginLeft: '30%' }}
                              >
                                {' '}
                                ${bal}
                              </h4>
                        ...
                        : (
                          <h4
                            style={{ fontSize: '15px', marginLeft: '70%' }}
                          >
                            $ {uptBal}
                          </h4>
                          )}
                  ...
                  <Col lg={3}>
                    <div className="assets-chart-wrap heading mt-0 mb-3" style={{
                      width: '230px',
                      height: '150%',
                      paddingBottom: '2%'
                    }}>
                  ...
                  <Col lg={3}>
                    <div className="assets-chart-wrap heading mt-0 mb-3" style={{ display: 'flex', width: '140px', marginTop: '-7%' }}>
                      <Link
                        to="#"
                        className="chart-box-item"
                      ...
                      <Link
                        to={'/PMS/Accountant/Transactions'}
                        className="chart-box-item"
                        style={{
                          marginLeft: '10%',
                          marginTop: '-29%',
                ...
                {/* <Link to="#">
                    ...
                    >
                      {wal_id?.[0]?.address_id}
                      {console.log(wal_id?.[0]?.address_id)}
                      {/* {console.log(result.user_invest)} */}
                {/* <Link to="#">
                        <Tooltip title="Copy to Clipboard">
                          <Icon
                            icon="cil:copy"
                            onClick={() => copyToClipboard(wal_id?.[0]?.address_id)}
                          />
                        </Tooltip>
                      </Link>
                    </h4> */}
                  ...
                  <Tab.Pane eventKey="first">
                    <div className="assets-pilll-info-box">
                      ...
                      <div className="datatable m-0">
                        ...
                        >
                          <ViewExchangeForAsset portfolio_id={walletIdAddress} />
                        </div>
                        <div className="assets-table-item"
                          style={{ marginBottom: '4%' }}
                        >
                          <ViewInvestmentForAssets portfolio_id={walletIdAddress} />
                        </div>
                      </div>
                    </div>
                  </Tab.Pane>
...
export default AssetsAccountant
