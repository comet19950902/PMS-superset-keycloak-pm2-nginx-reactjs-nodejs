                                ...
                                var result =  await axios.get(
                                    ...
                                    try {
                                        let history_wallet_data =await execquery('SELECT * FROM pms_user_balance WHERE address_id =?',[address_id])
                                            ...
                                            try {
                                                let sql = "REPLACE INTO pms_address_daily_snapshot (address_id_timeStamp, total_usd, address_id, timeStamp, wallet_id, portfolio_id, address_name, address_type) VALUES (?,?,?,?,?,?,?,?);"
