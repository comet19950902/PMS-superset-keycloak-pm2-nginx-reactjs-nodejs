          ...
          try {
              db.getConnection( async (err, connection) => {
                ...
                try {
                  ...
                  let sql = "REPLACE INTO pms_user_balance(address_id, total_usd_value, percent, timeStamp, portfolio_id,  wallet_id, address_name, address_type,ref_address_number,last_eth_time,recv_amount,send_amount,total_tran) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?);"
                  let resultdata =await execquery(sql, [address_id, Math.floor(asset_data.total_usd_value), per, new Date().toUTCString(), portfolio_id, wallet_id, address_name, address_type, refrence_address,last_eth_time,recv_amount,send_amount,total_tran])
