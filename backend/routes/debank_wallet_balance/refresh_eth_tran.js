...
const get_refresh_history_list = async(address_id,start_time, res)=>{
          ...
          // for (const asset of assetList) {
            try {
              ...
              console.log("token id",tokenId)
                  ...
                  let result_ammount = element.receives.map(({amount}) => amount);
                  ...
                  let senddd_ammount = element.sends.map(({amount}) => amount);
                  ...
                  console.log("symbol for amount id",amount_id);
...
module.exports = get_refresh_history_list