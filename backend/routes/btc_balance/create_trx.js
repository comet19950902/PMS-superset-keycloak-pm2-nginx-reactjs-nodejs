...
const create_btc_trx = async (btc_address_id, address_type,comment, res) => {
   ...
   let comment_data
    var config = {
        method: 'get',
        url: `https://blockchain.info/multiaddr?active=`+ btc_address_id + '&n=900000',
        headers: {}
      };
    ...
    //   };
      ...
      console.log("btc data for 1st",btcData.txs)
    ...
    try {
        db.getConnection(async (err, connection) => {
            ...
            try {
                ...
                const sqlSelect_btc = "Update btc_balance SET btc_last_time=? WHERE btc_address_id =?"
                let result_btc =await execquery(sqlSelect_btc,[btc_last_time,btc_address_id])       
