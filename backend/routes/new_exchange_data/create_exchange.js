...
const get_simple_protocol_exchange = async(portfolio_id,exchange_name,api_key,api_secret,exchange_type,user_id,res) => {
    ...
    try{
        ...
        console.log("res of balance",allbalance)
...
module.exports = get_simple_protocol_exchange